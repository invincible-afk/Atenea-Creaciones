...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-b from-pink-100 to-white dark:from-gray-900 dark:to-gray-800">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1582830557534-d2713a49f6c7?q=80&w=2000')] bg-cover bg-center opacity-20 dark:opacity-10" />
